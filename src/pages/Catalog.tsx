              ...
              <div className="text-gray-600">
                {loading ? (
                  <div className="flex items-center gap-2">
                    <div className="relative">
                      <div className="w-4 h-4 border-2 border-blue-100 rounded-full"></div>
                      <div className="w-4 h-4 border-2 border-blue-600 border-t-transparent rounded-full animate-spin absolute top-0 left-0"></div>
                    </div>
                    Carregando produtos...
                  </div>
                ) : (
