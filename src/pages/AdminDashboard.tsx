...
import { BarChart3, Users, DollarSign, ShoppingCart, CreditCard, TrendingUp, CheckCircle, XCircle } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'orders' | 'payouts' | 'users' | 'services'>('overview');
